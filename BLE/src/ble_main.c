...
******************************************************************************
*/
#define DEVICE_NAME                     "Chifoumelec"
#define MANUFACTURER_NAME               "ChifoumelecIndustrie"
...
******************************************************************************
*/
#define APP_ADV_INTERVAL                200                                     /**< The advertising interval (in units of 0.625 ms). */
...
static void on_adv_evt(ble_adv_evt_t ble_adv_evt)
{
    ...
    switch (ble_adv_evt)
    {
        ...
        case BLE_ADV_EVT_IDLE:
            NRF_LOG_INFO("Low advertising.");
            break;

        default:
            NRF_LOG_INFO("advertising %d", ble_adv_evt);
            break;
    }
}
...
static void advertising_init(void)
{
    ...
    m_advertising.p_adv_data = &m_adv_data;
...
static void services_init(void)
{
    ...
    // Initialize Service for dfu enter
    err_code = ble_dfu_init();
    APP_ERROR_CHECK(err_code);
}
