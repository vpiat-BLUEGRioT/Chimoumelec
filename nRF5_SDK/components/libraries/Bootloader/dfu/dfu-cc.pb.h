...
/* Generated by nanopb-0.3.6-dev at Thu Apr  9 16:53:06 2020. */
...
typedef enum
{
    DFU_FW_TYPE_APPLICATION_ISP = 0,
    DFU_FW_TYPE_SOFTDEVICE = 1,
    DFU_FW_TYPE_BOOTLOADER = 2,
    DFU_FW_TYPE_SOFTDEVICE_BOOTLOADER = 3,
    DFU_FW_TYPE_EXTERNAL_APPLICATION = 4,
    DFU_FW_TYPE_APPLICATION_STM32 = 5
} dfu_fw_type_t;
#define DFU_FW_TYPE_MIN DFU_FW_TYPE_APPLICATION_ISP
#define DFU_FW_TYPE_MAX DFU_FW_TYPE_APPLICATION_STM32
#define DFU_FW_TYPE_ARRAYSIZE ((dfu_fw_type_t)(DFU_FW_TYPE_APPLICATION_STM32+1))
...
#define DFU_INIT_COMMAND_INIT_DEFAULT            {false, 0, false, 0, 0, {0, 0, 0, 0}, false, (dfu_fw_type_t)0, false, 0, false, 0, false, 0, false, DFU_HASH_INIT_DEFAULT, false, false, 0, {DFU_BOOT_VALIDATION_INIT_DEFAULT, DFU_BOOT_VALIDATION_INIT_DEFAULT, DFU_BOOT_VALIDATION_INIT_DEFAULT}}
...
#define DFU_INIT_COMMAND_INIT_ZERO               {false, 0, false, 0, 0, {0, 0, 0, 0}, false, (dfu_fw_type_t)0, false, 0, false, 0, false, 0, false, DFU_HASH_INIT_ZERO, false, 0, 0, {DFU_BOOT_VALIDATION_INIT_ZERO, DFU_BOOT_VALIDATION_INIT_ZERO, DFU_BOOT_VALIDATION_INIT_ZERO}}
...
#define DFU_INIT_COMMAND_SIZE                    306
#define DFU_RESET_COMMAND_SIZE                   6
#define DFU_COMMAND_SIZE                         319
#define DFU_SIGNED_COMMAND_SIZE                  390
#define DFU_PACKET_SIZE                          715
